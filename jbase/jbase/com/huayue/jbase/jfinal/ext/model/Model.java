package com.huayue.jbase.jfinal.ext.model;
...
import com.huayue.jbase.util.Txt;
...
public class Model<M extends com.jfinal.plugin.activerecord.Model<M>> extends com.jfinal.plugin.activerecord.Model<M>
{
	...
	public List<M> listbyId(Object id)
	{
	...
	public List<M> listbycolumn()
	{
		return find(" select id,name from " + tableName);
	}
	public List<M> listbycolumnuser(Object userid)
	{
		return find(" select id,name from " + tableName+ " where user_name ='" + userid+"'");
	}
	
	public List<M> listcolumns(){
		return find("select * from information_schema.columns where table_name = '"+tableName+"'");
//		return find("select TABLE_SCHEMA,TABLE_NAME,ORDINAL_POSITION,COLUMN_NAME,DATA_TYPE,COLUMN_KEY from information_schema.columns where table_name = '"+tableName+"'");
	}
	public List<M> listcolumnname(){
		return find("select column_name from information_schema.columns where table_name = '"+tableName+"'");
	}
	public List<M> listcolumndatatype(){
		return find("select data_type from information_schema.columns where table_name = '"+tableName+"'");
	}
